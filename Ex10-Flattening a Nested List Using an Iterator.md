...
Define an interface-like class NestedInteger that can represent either a single integer or a nested list.


Use a stack or recursion to flatten all integers from the nested list into a single list.

Store the flattened list and maintain an index to track the current element.

Implement next() to return the next integer and hasNext() to check if more integers exist.

Test the iterator with a sample nested list.
...
<img width="413" height="90" alt="image" src="https://github.com/user-attachments/assets/06a588ab-1281-4526-86c6-bb9b646d2c7d" />

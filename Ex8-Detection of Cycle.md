...
Create a linked list and manually introduce a cycle for testing.
...
To find the start node of the cycle, reset one pointer to the head and move both one step at a time until they meet again.

Display the starting node of the cycle, or print “No cycle detected.” if none exists.
...
<img width="527" height="141" alt="image" src="https://github.com/user-attachments/assets/d878793f-599e-4a9e-b613-2e5de3992b49" />
